...
## 🛠 Skills
Spreadsheets:Excel, Google sheets (pivot, vlookup, SUMIF, IF, Hypothesis Testing(p-value), A/B Testing, Linear regression), SQLite , R Programming, Python for DA, Report & Dashboard (Looker Studio, Power BI), Machine Learning for DA, Statistics, Economic, Business & Marketing, Notion, GitHub / Prompt AI (Gemini, ChatGPT, NotebookLM) / Create Basic Website
