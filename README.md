...
## 🛠 Skills
Spreadsheets [Google sheets, Excel], SQL [SQLite] , R Programming (tidyverse, dplyr, ggplot2), Python for DA, Dashboard (Looker Studio), Machine Learning for DA, Statistics, Economic, Business & Marketing
